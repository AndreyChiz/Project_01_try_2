...
#ВОПРОС - конкретно в этой ситуации лучше в одну строчку или через for? вроде один словарь обрабатывать
# несколькими for на мой взгляд не кашерно будет, глаз резать будут оба варианта, если только for на отладке попроще.
